...
export default function AirdropCard({ airdrop, onClaim, claiming }: AirdropCardProps) {
    ...
    <GlassCard variant="glass" className="flex flex-col gap-3">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-500 font-mono truncate max-w-[180px]">{airdrop.token}</p>
        </div>
      ...
      <button
        ...
        disabled={claiming}
        className="w-full py-2.5 rounded-lg bg-w-blue font-semibold text-black text-sm disabled:opacity-50"
      >
